...
lock_stock = media.Movie("Lock Stock and Two Smoking Barrels",
                        ...
                        "http://www.theimdbapi.org/api/movie?movie_id=tt0120735")
...
in_the_loop = media.Movie("In The Loop",
                          ...
                          "http://www.theimdbapi.org/api/movie?movie_id=tt1226774")
...
harry_potter = media.Movie("Harry Potter film series",
                           ...
                           "http://www.theimdbapi.org/api/movie?movie_id=tt0241527")
...
snatch = media.Movie("Snatch",
                     ...
                     "http://www.theimdbapi.org/api/movie?movie_id=tt0208092")
...
full_monty = media.Movie("The Full Monty",
                         ...
                         "http://www.theimdbapi.org/api/movie?movie_id=tt0119164")
...
trainspotting = media.Movie("Trainspotting",
                            ...
                            "http://www.theimdbapi.org/api/movie?movie_id=tt0117951")
